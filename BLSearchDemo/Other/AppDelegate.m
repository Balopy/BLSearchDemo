...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BLSeachBookViewController *searchVc = [[BLSeachBookViewController alloc] init];
    
    UINavigationController *navVC = [[UINavigationController alloc] initWithRootViewController:searchVc];
    [navVC.navigationBar setBarTintColor:[UIColor colorWithRed:0.4 green:0.8 blue:0.6 alpha:1]];
